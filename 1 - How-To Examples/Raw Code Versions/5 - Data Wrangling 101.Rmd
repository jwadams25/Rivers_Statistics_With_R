...
```{r using select for the first time}
...
#### 1. Use the group_by function to find the summary statistics for price across a different categorical variable.

```{r group_by on your own}
