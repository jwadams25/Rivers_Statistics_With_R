...
1. Start by highlighting from RGVB_team through 0.3) and then run the code by hitting command-option-i on your keyboard. 
Having done that, what does geom_jitter add to the visualization?

2. Now highlight from RGVB_team through "red")) and then run the code by hitting command-option-i on your keyboard. 
What does the code scale_color_manual do?

3. Now highlight from RGVB_team through color = "") and then run the code by hitting command-option-i on your keyboard. 
What does the code labs do?

4. Now highlight from RGVB_team through theme_classic() and then run the code by hitting command-option-i on your keyboard. 
